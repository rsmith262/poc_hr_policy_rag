...
# if statement checks the list of index names. If it does exist it deletes it then recreates a blank index
# If it doesn't exist it creates a new blank index
# It use the .env variable for the container name
